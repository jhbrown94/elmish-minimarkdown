module Main exposing (Markup(..), State, clearBold, clearItalic, confirmBold, confirmItalic, confirmNoChange, finalizeState, handleCloseBold, handleCloseItalic, handleRightSlash, handleRightStar, initialState, parseAfterLeftSlash, parseAfterLeftStar, parseAfterText, parseText, parseWhitespace, prefix, push, startParse)
